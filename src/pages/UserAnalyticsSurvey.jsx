...
import { analyticsData, stepsData } from "../mock_data/data";
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <motion.div
        ...
        className={`   min-h-[90vh] w-screen flex justify-center items-center `}
      >
        {/* main body */}
        <div className="bg-gray-50 w-full ">
          <div className="w-[95%] 2xl:w-[80%] h-full mx-auto py-5 pt-0">
            {/* nps section */}
            <div>
              {/* heading */}
...
export default UserAnalyticsSurvey;
